...
Function Cleanup
{
    ...
    foreach ($app in $apps) 
    {
        ...
        Write-Host "Removed ms-identity-nodejs-webapi-azurefunctions.."
    }
    # also remove service principals of this app
    Get-AzureADServicePrincipal -filter "DisplayName eq 'ms-identity-nodejs-webapi-azurefunctions'" | ForEach-Object {Remove-AzureADServicePrincipal -ObjectId $_.Id -Confirm:$false}
